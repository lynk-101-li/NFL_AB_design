...
| Antibody 1 epitope | helix_surface_323_331 (323-331) |
| Antibody 1 binding proxy | 87.17 |
| Antibody 2 | 15-C12-H6 |
| Antibody 2 epitope | C_boundary_368_377 (368-377) |
| Antibody 2 binding proxy | 86.52 |
| Epitope overlap ratio | 0.0 |
| Linear epitope gap aa | 36 |
| Clash proxy score | 0.0 |
| Sandwich compatibility proxy | 96.43 |
...
Reason: capture orientation prioritizes explicit retrospective evidence when present, then simulated developability; experimental label-site and orientation tests remain required.
